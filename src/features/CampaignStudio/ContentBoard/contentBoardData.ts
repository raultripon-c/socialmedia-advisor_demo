...
export const culturalCalendarEvents: CulturalCalendarEvent[] = [
  {
    ...
    contentTemplates: [
      "Happy New Year from One Health. This year we're investing in fresh perspectives, continuous learning, and careers that help our teams grow while serving patients across North Carolina. Explore roles that start with purpose: careers.dukehealth.org",
      "A new year, a new chapter. At One Health, growth isn't a resolution — it's how we care. Discover where your next step could lead: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "Great careers are built with great mentors. This National Mentoring Month, we're celebrating the One Health leaders who invest in the next generation of caregivers. Grow with us: careers.dukehealth.org",
  ...
  },
  {
    ...
    contentTemplates: [
      "On Martin Luther King Jr. Day, One Health recommits to equity, inclusion, and care that reflects every community we serve. Join a team where belonging and opportunity grow together: careers.dukehealth.org",
      "Dr. King reminded us that the time is always right to do what is right. At One Health, that means equitable care and an inclusive workplace, every day: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "During Black History Month, we celebrate the caregivers, researchers, and leaders who strengthen One Health every day. Community, honor, and equal opportunity guide how we hire and how we care: careers.dukehealth.org",
      "Excellence has many faces. This Black History Month, we honor the Black professionals shaping the future of care at One Health: careers.dukehealth.org",
    ],
  },
  {
    id: "heart-health-day",
    ...
    contentTemplates: [
      "Today we go red for heart health. One Health's cardiovascular teams protect hearts every day — and we're hiring the people who make that possible: careers.dukehealth.org",
      "Heart health starts with the people who care for it. Join the One Health teams keeping our communities strong: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "Kindness is a clinical skill too. On Random Acts of Kindness Day, we're grateful for the small moments that make One Health feel like family — for patients and teammates alike: careers.dukehealth.org",
      "A warm hand, a reassuring word, a coffee for a colleague. Kindness defines care at One Health. Come be part of it: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "This Women's History Month, One Health celebrates the women advancing care, discovery, and leadership across our health system. Build your career with us: careers.dukehealth.org",
      "From the bedside to the boardroom, women lead at One Health. Explore where your leadership belongs: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "Today we celebrate the people of One Health. From bedside to research labs, your dedication defines our culture. Thank you for putting patients and each other first: careers.dukehealth.org",
      "Our people are our purpose. On Employee Appreciation Day, thank you to every teammate who makes One Health extraordinary: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "On International Women's Day, we honor the women who drive One Health forward — in nursing, medicine, research, and leadership. Join them: careers.dukehealth.org",
  ...
  },
  {
    ...
    contentTemplates: [
      "On National Doctors' Day, thank you to the physicians whose expertise and compassion define One Health. Practice where excellence is the standard: careers.dukehealth.org",
      "Behind every breakthrough is a physician who never stopped caring. Celebrate Doctors' Day with One Health: careers.dukehealth.org",
    ],
  },
  {
    id: "world-health-day",
    ...
    contentTemplates: [
      "This World Health Day, One Health reaffirms our commitment to healthier communities — and to the teams that make it happen. Join the mission: careers.dukehealth.org",
      "Health is a right, not a privilege. Help One Health advance care for everyone: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "This National Volunteer Week, we celebrate One Health teammates who give their time to strengthen our communities. Care beyond the shift: careers.dukehealth.org",
  ...
  },
  {
    ...
    contentTemplates: [
      "This Earth Day, One Health is focused on responsible care for people and planet — from greener campuses to smarter clinical operations. Build a career with purpose beyond the shift: careers.dukehealth.org",
      "Healthy planet, healthy people. Join the One Health teams building a more sustainable future for care: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "Care doesn't run without them. On Administrative Professionals Day, thank you to the One Health teams keeping everything moving. Explore roles: careers.dukehealth.org",
  ...
  },
  {
    ...
    contentTemplates: [
      "It's National Nurses Week. To the nurses of One Health: your skill and heart change lives every shift. Thank you — and if you're a nurse looking for your next home, explore with us: careers.dukehealth.org/search-jobs/registered%20nurse",
      "Nurses are the heartbeat of One Health. This Nurses Week, we celebrate you — and invite great nurses to join us: careers.dukehealth.org/search-jobs/registered%20nurse",
    ],
  },
  {
    id: "mothers-day",
    ...
    contentTemplates: [
      "This Mother's Day, we honor the moms on our teams who care for patients and family alike. One Health supports the people who do it all: careers.dukehealth.org",
      "To every mother caring for others at One Health — thank you. Find a workplace that supports your whole life: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "This Mental Health Awareness Month, One Health is doubling down on wellbeing — because caring for others starts with caring for our teams. Join a workplace that has your back: careers.dukehealth.org",
      "Your wellbeing matters here. Explore a culture built on psychological safety at One Health: careers.dukehealth.org",
    ],
  },
  {
    id: "memorial-day",
    ...
    contentTemplates: [
      "This Memorial Day, One Health honors those who served. We remain grateful for the courage that protects our communities — and committed to compassionate care for veterans and families: careers.dukehealth.org",
  ...
  },
  {
    ...
    contentTemplates: [
      "Pride Month at One Health means authenticity and belonging every day — not just in June. Join teams where psychological safety helps people thrive and patients feel seen: careers.dukehealth.org",
      "Bring your whole self to work. This Pride Month, celebrate a One Health culture where everyone belongs: careers.dukehealth.org",
    ],
  },
  {
    id: "juneteenth",
    ...
    contentTemplates: [
      "On Juneteenth, One Health reflects on freedom, progress, and the work still ahead. We're building workplaces and care experiences grounded in equity for every team member and every patient: careers.dukehealth.org",
      "Juneteenth is a celebration of freedom and a call to keep going. Join a One Health team committed to equity: careers.dukehealth.org",
    ],
  },
  {
    id: "fathers-day",
    ...
    contentTemplates: [
      "This Father's Day, we celebrate the dads on our teams balancing care at work and at home. One Health supports your whole life: careers.dukehealth.org",
      "To the fathers caring for our patients and their own families — thank you. Grow your career with One Health: careers.dukehealth.org",
    ],
  },
  {
    id: "independence-day",
    ...
    contentTemplates: [
      "Happy Independence Day from One Health. Across clinics, hospitals, and communities, our teams collaborate to keep care close to home. Find your next role with purpose: careers.dukehealth.org",
  ...
  },
  {
    ...
    contentTemplates: [
      "This National Intern Day, we celebrate the students launching healthcare careers at One Health. Start yours with us: careers.dukehealth.org",
      "Today's intern is tomorrow's leader. Explore early-career pathways at One Health: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "Skills change lives. This World Youth Skills Day, discover the training and development that launch careers at One Health: careers.dukehealth.org",
      "We invest in potential. Explore skill-building roles and programs at One Health: careers.dukehealth.org",
    ],
  },
  {
    id: "wellness-month",
    ...
    contentTemplates: [
      "This National Wellness Month, One Health is prioritizing the wellbeing of the people who care for others. Explore a workplace that supports you: careers.dukehealth.org",
      "Wellbeing isn't a perk, it's our culture. Join One Health this Wellness Month: careers.dukehealth.org",
    ],
  },
  {
    id: "labor-day",
    ...
    contentTemplates: [
      "This Labor Day, One Health celebrates the dedication behind every patient outcome — and the well-being that sustains it. Explore careers that value hard work and balance: careers.dukehealth.org",
      "Hard work deserves real support. This Labor Day, discover a One Health career built to last: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "This Suicide Prevention Month, One Health stands for support, connection, and hope — for our patients and our teams. Join a workplace that cares: careers.dukehealth.org",
      "You are not alone. This month and every month, One Health invests in mental-health support for our people: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "This Hispanic Heritage Month, One Health celebrates the Hispanic and Latino teammates enriching our care and culture. Join us: careers.dukehealth.org",
      "Representation strengthens care. Celebrate Hispanic Heritage Month with a One Health team that reflects our communities: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "This National Disability Employment Awareness Month, One Health reaffirms our commitment to accessible, inclusive careers for all. Explore opportunities: careers.dukehealth.org",
      "Inclusion means everyone. Discover an accessible workplace at One Health: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "This Breast Cancer Awareness Month, we honor One Health's oncology teams and the patients they fight alongside. Join a team that cares deeply: careers.dukehealth.org",
      "Early detection saves lives — and so do compassionate care teams. Explore oncology careers at One Health: careers.dukehealth.org",
    ],
  },
  {
    id: "halloween",
    ...
    contentTemplates: [
      "The only thing scary at One Health is how much fun our teams have together. Happy Halloween! Come join the crew: careers.dukehealth.org",
      "Treats, team spirit, and great care. Happy Halloween from One Health — we're hiring: careers.dukehealth.org",
    ],
  },
  {
    id: "veterans-day",
    ...
    contentTemplates: [
      "On Veterans Day, One Health thanks the service members and veterans on our teams. Leadership, resilience, and integrity strengthen the care we deliver every day: careers.dukehealth.org",
      "Veterans make exceptional caregivers. This Veterans Day, discover a One Health career that values your service: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "This Native American Heritage Month, One Health honors the traditions, resilience, and contributions of Native communities and teammates. Join an inclusive team: careers.dukehealth.org",
      "Care that respects every culture. Celebrate Native American Heritage Month with One Health: careers.dukehealth.org",
    ],
  },
  {
    id: "thanksgiving",
    ...
    contentTemplates: [
      "This Thanksgiving, One Health is grateful for the teams and partners who make excellent care possible. Thank you for the teamwork behind every moment that matters: careers.dukehealth.org",
      "Grateful for our people, our patients, and our community. Happy Thanksgiving from One Health: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "On World Kindness Day, we celebrate the compassion that defines One Health. Join a team where kindness is care: careers.dukehealth.org",
      "Small kindnesses, big impact. Discover a workplace built on compassion at One Health: careers.dukehealth.org",
    ],
  },
  {
    ...
    contentTemplates: [
      "This International Volunteer Day, we celebrate One Health teammates who give back to our communities. Care that goes further: careers.dukehealth.org",
      "Giving back is part of who we are. Join a One Health team that shows up for the community: careers.dukehealth.org",
    ],
  },
  {
    id: "human-rights-day",
    ...
    contentTemplates: [
      "On Human Rights Day, One Health reaffirms that dignity and equity belong to everyone — patients and teammates alike. Join us: careers.dukehealth.org",
      "Care is a human right. This Human Rights Day, build a career grounded in dignity at One Health: careers.dukehealth.org",
    ],
  },
  {
    id: "winter-holidays",
    ...
    contentTemplates: [
      "As the year closes, One Health reflects on the care, discovery, and community impact our teams delivered — and prioritizes well-deserved rest. Start the next chapter with us: careers.dukehealth.org",
      "Season's greetings from One Health. Grateful for a year of care, and excited for what's ahead. Explore your future with us: careers.dukehealth.org",
    ],
  },
];
...
const generateMediaListeningCards = (year: number): AdvisorCard[] => [
  ...
  },
  {
    ...
    copy:
      "Create an employer brand campaign for One Health Nursing celebrating Magnet-level recognition for care, leadership, and professional practice. Target experienced Registered Nurses in Durham, NC with a warm, professional tone that highlights excellence and growth. Drive candidates to https://careers.dukehealth.org/search-jobs/registered%20nurse.",
    category: "Recognition",
